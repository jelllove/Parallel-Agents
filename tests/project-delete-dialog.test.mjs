...
test('project deletion initially requires acknowledgement but never project-name typing', async () => {
  ...
  const html = renderToStaticMarkup(createElement(module.exports.ProjectDeleteDialog, {
    projects: [{ id: 'codex:repo', agent: 'codex', displayName: 'Nexus workspace', realPath: 'C:\\Nexus' }],
    onConfirm: async () => { throw new Error('Must not delete before confirmation'); },
    onCancel() {},
  }));
